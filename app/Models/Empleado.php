...
class Empleado extends Model
{
    ...
    protected $fillable = [
        'nit', 'igss', 'imagen', 'nombres', 'apellidos', 'email', 'fecha_ingreso',
        ...
        'otro_etnia', 'generos_id', 'etnias_id', 'grupos_sanguineos_id', 'dependencias_funcionales_id', 'municipios_id',
        'tipos_lincencias_id', 'nacionalidades_id', 'tipos_viviendas_id', 'estados_civiles_id', 'ubicacion_geografica', 'candidatos_id'
    ];
}
