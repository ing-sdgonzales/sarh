                                ...
                                <div
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-50">
                                            ...
                                            <div>
                                                <a href="{{ route('candidatos') }}" class="font-semibold text-gray-900">
                                                    {{ __('Reclutamiento') }}
                                        ...
                                        <div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-50">
                                            ...
                                            <div>
                                                <a href="{{ route('empleados') }}" class="font-semibold text-gray-900">
                                                    {{ __('Empleados') }}
                                                    <span class="absolute inset-0"></span>
                                                </a>
                                        ...
                                        <div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-50">
                                            ...
                                            <div>
                                                <a href="{{ route('requisitos') }}" class="font-semibold text-gray-900">
                                                    {{ __('Requisitos') }}
                                                    <span class="absolute inset-0"></span>
                                                </a>
