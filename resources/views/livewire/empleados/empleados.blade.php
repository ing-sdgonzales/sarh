                ...
                <table class="min-w-full bg-white rounded-lg text-center">
                    <thead class="bg-gray-100 text-center overflow-hidden">
                        <tr>
                            ...
                            <th class="w-1/12 py-2 px-4">NIT</th>
                            ...
                            <tr>
                                ...
                                <td class="py-2 px-4">
                                    ...
                                    @elseif ($empleado->estado == 1)
                                        <span
                                            class="inline-block whitespace-nowrap rounded-[0.27rem] bg-success-400 px-[0.65em] pb-[0.25em] pt-[0.35em] text-center text-md align-baseline text-[0.75em] font-bold leading-none text-succes-800">Activo</span>
                                    @else
                                        <span
                                ...
                                <td class="py-2 px-4">
                                    <div class="relative" data-te-dropdown-position="dropstart">
                                        <button
                                            ...
                                            type="button" id="dropdownMenuButton{{ $empleado->id }}"
