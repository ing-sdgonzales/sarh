                                ...
                                <div class="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="sm:col-span-1">
                                        <label for="tipo_licencia"
                                            ...
                                            licencia</label>
                                        <div class="mt-2">
                                            <select wire:model='tipo_licencia' id="tipo_licencia"
                                                name="tipo_licencia"
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                <option value="">Seleccionar...</option>
                                    ...
                                    <div class="sm:col-span-2">
                                        <label for="tipo_vehiculo"
                                            ...
                                            vehículo</label>
                                        <div class="mt-2">
                                            <select wire:model='tipo_vehiculo' id="tipo_vehiculo"
                                                name="tipo_vehiculo"
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                <option value="">Seleccionar...</option>
                            ...
                            <div class="border-b border-gray-900/10 pb-6">
                                ...
                                <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <div class="mt-2">
                                            <input wire:model='titulo_secundaria' type="text"
                                                name="titulo_secundaria" id="titulo_secundaria"
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                        <div>
                                            <span class="text-red-600 text-sm">
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <div class="mt-2">
                                            <input wire:model='establecimiento_diversificado' type="text"
                                                name="establecimiento_diversificado"
                                                id="establecimiento_diversificado"
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                        <div>
                                            <span class="text-red-600 text-sm">
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <div class="mt-2">
                                            <input wire:model='establecimiento_universitario' type="text"
                                                name="establecimiento_universitario"
                                                id="establecimiento_universitario"
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                        <div>
                                            <span class="text-red-600 text-sm">
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                            <input wire:model='establecimiento_estudio_actual' type="text"
                                                name="establecimiento_estudio_actual"
                            ...
                            <div class="border-b border-gray-900/10 pb-6">
                                ...
                                <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="sm:col-span-4">
                                        ...
                                        <div class="mt-2">
                                            <input wire:model='historiales_laborales.0.razon_informacion'
                                                type="text" name="razon_informacion_0" id="razon_informacion_0"
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                        <div>
                                            <span class="text-red-600 text-sm">
                                    ...
                                    <div class="sm:col-span-4">
                                        ...
                                        <div class="mt-2">
                                            <input wire:model='historiales_laborales.1.razon_informacion'
                                                type="text" name="razon_informacion_1" id="razon_informacion_1"
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                        <div>
                                            <span class="text-red-600 text-sm">
                                    ...
                                    <div class="sm:col-span-4">
                                        ...
                                        <div class="mt-2">
                                            <input wire:model='historiales_laborales.2.razon_informacion'
                                                type="text" name="razon_informacion_2" id="razon_informacion_2"
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                        <div>
                                            <span class="text-red-600 text-sm">
                                ...
                                <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="sm:col-span-2">
                                        <label for="rp_lugar_trabajo_0"
                                            ...
                                            trabajo</label>
                                        <div class="mt-2">
                                            <input wire:model='referencias_personales.0.lugar_trabajo'
                                                type="text" name="rp_lugar_trabajo_0" id="rp_lugar_trabajo_0"
                                                required
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                        <div>
                                    ...
                                    <div class="sm:col-span-2">
                                        <label for="rp_lugar_trabajo_1"
                                            ...
                                            trabajo</label>
                                        <div class="mt-2">
                                            <input wire:model='referencias_personales.1.lugar_trabajo'
                                                type="text" name="rp_lugar_trabajo_1" id="rp_lugar_trabajo_1"
                                                required
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                        <div>
                                    ...
                                    <div class="sm:col-span-2">
                                        <label for="rp_lugar_trabajo_2"
                                            ...
                                            trabajo</label>
                                        <div class="mt-2">
                                            <input wire:model='referencias_personales.2.lugar_trabajo'
                                                type="text" name="rp_lugar_trabajo_2" id="rp_lugar_trabajo_2"
                                                required
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                        <div>
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                            <input wire:model='telefono_contacto_emergencia' type="text"
                                                ...
                                                id="telefono_contacto_emergencia" required
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                        <div>
                                            <span class="text-red-600 text-sm">
                                    ...
                                    <div class="sm:col-span-6">
                                        ...
                                        <div class="mt-2">
                                            <input wire:model='direccion_contacto_emergencia' type="text"
                                                ...
                                                id="direccion_contacto_emergencia" required
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                        <div>
                                            <span class="text-red-600 text-sm">
