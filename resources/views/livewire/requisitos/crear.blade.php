                        ...
                        <div class="pb-6">
                            <div class="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div class="sm:col-span-full">
                                    <x-label for="requisito" value="{{ __('Requisito') }}" />
                                    <div class="mt-2">
                                        <x-input wire:model='requisito' type="text" name="requisito" id="requisito"
                                ...
                                <div class="sm:col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <x-textarea wire:model='especificacion' id="especificacion" name="especificacion"
                                        rows="3"
