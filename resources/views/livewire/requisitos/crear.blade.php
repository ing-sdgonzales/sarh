                        ...
                        <div class="border-b border-gray-900/10 pb-6">
                            <div class="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div class="sm:col-span-full">
                                    <label for="requisito"
                                        class="block text-sm font-medium leading-6 text-gray-900">Requisito</label>
                                    <div class="mt-2">
                                        <input wire:model='requisito' type="text" name="requisito" id="requisito"
                                            required
                                ...
                                <div class="sm:col-span-full">
                                    <label for="especificacion"
                                        class="block text-sm font-medium leading-6 text-gray-900">Especificación</label>
                                    <div class="mt-2">
                                        <textarea wire:model='especificacion' id="especificacion" name="especificacion" rows="3"
