                        ...
                        <div class="border-b border-gray-900/10 pb-6">
                            <div class="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div class="sm:col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <input wire:model='capacitacion' type="text" name="capacitacion"
                                            id="capacitacion" required
                                ...
                                <div class="sm:col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <select wire:model='organizador' id="organizador" name="organizador" required
                                ...
                                <div class="sm:col-span-full">
                                    <label for="capacitador"
                                        class="block text-sm font-medium leading-6 text-gray-900">Capacitador</label>
                                    <div class="mt-2">
                                        <input wire:model='capacitador' type="text" name="capacitador"
                                            id="capacitador" required
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        <div>
                                            <span class="text-red-600 text-sm">
                                                @error('capacitador')
