        ...
        <div class="inline-block align-bottom bg-gray-100 dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full"
            ...
            <div
                ...
                <h5 class="text-xl font-medium leading-normal text-neutral-800 dark:text-neutral-200"
                    ...
                    Habilitar registro para actualización
                </h5>
                <!--Close button-->
                        ...
                        <div class="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-full">
                                <p class="text-justify text-lg dark:text-gray-200">
                                    Habilitar el registro de esta Dirección o Unidad permite que el responsable del
                                    formulario pueda actualizar el Estado de Fuerza del personal y contratistas.
                                </p>
                                <br>
                                <p class="text-justify text-lg dark:text-gray-200">
                                    Por favor, confirme que el registro que desea habilitar sea el correcto.
                                </p>
                                ...
                                <div class="mt-8 mb-3 inline-flex w-full items-center rounded-lg bg-warning px-6 py-5 text-base text-warning-900"
                                    ...
                                    <p><b>Importante: </b>El registro se deshabilita automáticamente después de su
                                        actualización.</p>
                                </div>
                            </div>
                        </div>
            ...
            <div
                ...
                <button type="button" wire:click='habilitarDir'
