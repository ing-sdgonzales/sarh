                    ...
                    <div class="border-b border-gray-900/10 dark:border-b-gray-600 pb-6">
                        <div class="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <x-input wire:model='direccion' type="text" name="direccion" id="direccion"
                                        required class="block w-full" disabled readonly />
                                </div>
                                <div>
                                    <span class="text-red-600 text-sm">
                                        @error('direccion')
                            ...
                            <div class="sm:col-span-full">
                                <div class="text-xl">
                                    <h1 class="p-2 mt-8 font-semibold leading-7 text-gray-900 dark:text-gray-400">
                                        Registro
                                        de personal
                                    </h1>
                                </div>
