        ...
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 mb-2">
                <div class="sm:col-span-6 mx-auto">
                    ...
                    <x-label class="block text-sm font-medium leading-6" value="{{ __($candidato->nombre) }}" />
                </div>
                    ...
                    <div class="mt-2 w-full text-right items-baseline">
                        @can('Ver etapas')
                            <a type="button" href="{{ route('proceso', ['id_candidato' => $id_candidato]) }}">
                                <div
                                    class="inline-block rounded-lg bg-success px-6 pb-2 pt-2.5 text-md font-medium leading-normal text-white transition duration-150 ease-in-out hover:bg-success-600 focus:bg-success-600 focus:outline-none focus:ring-0 active:bg-success-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]">
                                    {{ __('Progreso') }}
                                </div>
                            </a>
                        @endcan
                        @can('Notificar requisitos')
                            <button type="button" wire:click="notificar" @if ($notificar == false) disabled @endif
                                class=" @if ($notificar == false) pointer-events-none @endif inline-block rounded-lg bg-primary px-6 pb-2 pt-2.5 text-md font-medium leading-normal text-white transition duration-150 ease-in-out hover:bg-primary-600 focus:bg-primary-600 focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] disabled:opacity-60 dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]">
                                {{ __('Notificar') }}
                            </button>
                        @endcan
                    </div>
                            ...
                            @foreach ($requisitos as $req)
                                <tr
                                    ...
                                    @if ($req->fecha_carga != null)
                                        <td
                                            class="py-2 px-4 {{ $loop->last ? 'border-none' : 'border-b border-gray-200 dark:border-gray-700' }}">
                                            {{ date('d-m-Y H:i:s', strtotime($req->fecha_carga)) }}
                                        </td>
                                    @else
                                        <td>
                                            <span
