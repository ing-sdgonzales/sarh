                        ...
                        <div>
                            <div class="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div class="sm:col-span-full">
                                    <x-label for="aprobado" value="{{ __('Estado') }}" />
                                    <div class="mt-2">
                                        <x-select wire:model='aprobado' id="aprobado" name="aprobado" required
                                            class="block w-full">
                                ...
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <x-textarea wire:model='observacion' id="observacion" name="observación" rows="3" required
                                        class="block w-full"></x-textarea>
                                        
                                    </div>
                                    <p class="mt-3 text-sm leading-6 dark:text-gray-200 text-gray-600">Breve descripción de la entrevista.
                                    </p>
                                </div>
                            </div>
                        </div>
